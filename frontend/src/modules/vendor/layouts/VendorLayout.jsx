...
const VendorLayout = () => {
    ...
    return (
        <div className="admin-theme flex flex-col min-h-screen">
            ...
            <main className={`flex-1 pb-24 md:pb-12 bg-slate-50/50 ${showHeader ? (['/vendor/walk-in', '/vendor/material-request', '/vendor/labor-request', '/vendor/labor-request/create', '/vendor/material-orders'].includes(currentPath) ? 'pt-16' : 'pt-20') : ''}`}>
                <Outlet />
            </main>
