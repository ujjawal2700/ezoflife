...
import { Table, TableHeader, TableBody, TableHead, TableRow, TableCell, TablePagination, StatusBadge } from '@/shared/components/ui/table';
        ...
        <div className="p-8 space-y-8 max-w-6xl mx-auto">
            <header className="flex justify-between items-center">
                ...
                <div className="bg-slate-50 px-6 py-2.5 rounded-2xl border border-slate-100 shadow-sm">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">{ads.length} Total Campaign(s)</span>
                </div>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                    <div className="p-8 border-b border-slate-50 flex justify-between items-center">
                        ...
                        <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">{ads.length} Campaign(s)</span>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        <Table className="w-full text-left">
                            ...
                            <TableBody>
                                {loading ? (
                                    <TableRow>
                                        <TableCell colSpan="6" className="px-8 py-12 text-center text-slate-400">Loading your campaigns...</TableCell>
                                    </TableRow>
                                ) : (
                                    paginatedAds.map((ad) => (
                                        <TableRow key={ad._id} className="hover:bg-slate-50/50 transition-colors">
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <p className="text-sm text-slate-600">{new Date(ad.createdAt).toLocaleDateString('en-GB')}</p>
                                            ...
                                            <TableCell>
                                                <button 
                                                    ...
                                                    className={`px-3 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wide border transition-all ${
                                ...
                                {ads.length === 0 && !loading && (
                                    <TableRow>
                                        <TableCell colSpan="6" className="px-8 py-32 text-center text-slate-300">
