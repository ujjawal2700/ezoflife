...
const navItems = [
  {
    ...
    items: [
            ...
            subItems: [
              {
                ...
                path: "/admin/users?role=Customer&type=individual",
              },
              {
                label: "Business Customers",
                path: "/admin/users?role=Customer&type=retail",
              },
            ],
          },
          {
            ...
            subItems: [
              {
                ...
                path: "/admin/users?role=Vendor&vendorType=registered",
              },
              {
                label: "Unregistered Vendors",
                path: "/admin/users?role=Vendor&vendorType=unregistered",
              },
            ],
          },
      ...
      { icon: UserCircle, label: "User Role", path: "/admin/users/roles" },
      {
        ...
        subItems: [
          {
            label: "Vendor Registration Request",
            path: "/admin/vendors/approvals",
          },
          {
            label: "Supplier Registration Request",
            path: "/admin/supplier-requests",
          },
        ],
      },
      {
      ...
      {
        icon: ClipboardList,
        label: "Supplier Product Request",
        path: "/admin/supplier-product-requests",
      },
      {
        icon: ShoppingBag,
        label: "Orders",
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            label: "Product Table",
            path: "/admin/vendor-supply-pricing/products",
          },
          {
            label: "Supplier Service Zone",
            path: "/admin/vendor-supply-pricing/zones",
          },
          {
            label: "Master Supplies Table",
            path: "/admin/vendor-supply-pricing/supplies",
          },
          {
            label: "Platform Fee",
            path: "/admin/vendor-supply-pricing/platform-fee",
          },
          {
            label: "Vendor Supply Orders",
            path: "/admin/vendor-supply-pricing/orders",
          },
        ],
      },
        ...
        subItems: [
          {
            ...
            path: "/admin/help-desk?activeTab=Customer",
          },
          { label: "Vendor Issues", path: "/admin/help-desk?activeTab=Vendor" },
          {
            label: "Supplier Issue",
            path: "/admin/help-desk?activeTab=Supplier",
          },
          { label: "Missing Item Dispute", path: "/admin/dispute-center" },
          { label: "Active Orders Issues", path: "/admin/dispute-center" },
        ],
      },

      {
        ...
        subItems: [
          { label: "Offers", path: "/admin/notifications?type=offers" },
          {
            ...
            path: "/admin/notifications?type=maintenance",
          },
          {
            label: "Payment reminder",
            path: "/admin/notifications?type=payment",
          },
        ],
      },
...
export default function Sidebar({
        ...
        const matchingItems = group.items.filter((item) => {
          ...
          const subItemMatches =
            ...
            item.subItems.some((sub) => {
              ...
              const nestedMatches =
                sub.subItems &&
                sub.subItems.some((n) => n.label.toLowerCase().includes(query));
  ...
  useEffect(() => {
    if (searchTerm.trim()) {
      const firstWithSub = searchFilteredNavItems
        .flatMap((g) => g.items)
        .find((i) => i.subItems && i.subItems.length > 0);
      if (firstWithSub) {
                  ...
                  <div key={item.label}>
                    <button
                      ...
                      <div className="relative shrink-0 flex items-center">
                        <item.icon
                          size={16}
                          className={`${isActive ? "text-white" : "group-hover:text-slate-900 transition-colors"}`}
                        />
                      ...
                      {(!isCollapsed || isMobileOpen) && (
                        <>
                          <span
                            className={`font-bold text-[10px] uppercase tracking-[0.05em] flex-1 text-left whitespace-nowrap overflow-hidden transition-all ${
                              isActive
                                ? "opacity-100"
                          ...
                          {badgeCount > 0 && (
                            <span
                              className={`px-1.5 py-0.5 rounded-full text-[8.5px] font-black leading-none shrink-0 ${
                                isActive
                                  ...
                                  <div
                                    ...
                                    <button
                                      ...
                                      className={`w-full flex items-center justify-between px-4 py-2 text-[9px] font-bold uppercase tracking-wider transition-all ${
                                        isSubActive
                                          ? "text-slate-900 bg-slate-100/30"
                                          : "text-slate-400 hover:text-slate-900 hover:bg-slate-100/10"
                                      }`}>
                                      <span>{sub.label}</span>
                                      <ChevronDown
                                        size={10}
                                              ...
                                              <button
                                                ...
                                                className={`w-full text-left px-4 py-1.5 text-[8.5px] font-bold uppercase tracking-wider transition-all ${
                                                  isNestedActive
                                                    ...
                                                    : "text-slate-400 hover:text-slate-900 hover:bg-slate-200/20"
                                                }`}>
                                                {nested.label}
                                              </button>
                                            );
